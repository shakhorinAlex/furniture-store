    ...
    <div>
      <section className='hero section'>
        <div className='container'>
          ...
          <p className='hero__desc'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Semper eget ultrices gravida gravida. Suspendisse pharetra quis eros facilisi.
          </p>
      ...
      <section className='section products'>
        <div className='container'>
          ...
          <p className='products__desc'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Est id pretium pellentesque leo. Lorem.
          </p>
      ...
      <section className='section quality'>
        <div className='container'>
          ...
          <h3 className='quality__title'>Our <b>Products</b> are made with <b>high quality</b> european fabric and sewn by a small team <b>CRAFTSPEOPLE</b> in <b>EUROPE</b>
          </h3>
        </div>
      </section>
      <section className='section collection'>
        <div className='container'>
          ...
          <p className='collection__desc'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Est id pretium pellentesque leo. Lorem.</p>
          <ul className='collection__container'>
            <li className='collection__card card1'>
              <img className='collection__img' src="./images/collection4.jpg" alt='' />
              <h4 className='collection__name'>Collection 1</h4>
            </li>
            <li className='collection__card card2'>
              <img className='collection__img' src="./images/collection2.jpg" alt='' />
              <h4 className='collection__name'>Collection 2</h4>
            </li>
            <li className='collection__card card3'>
              <img className='collection__img' src="/images/collection3.jpg" alt='' />
              <h4 className='collection__name'>Collection 3</h4>
            </li>
            <li className='collection__card card4'>
              <img className='collection__img' src="./images/collection1.jpg" alt='' />
